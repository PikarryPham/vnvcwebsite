...
const BasicCard = ({ma, danhSachMuiTiem, maVaccine, ten, gia, phongbenh, thongtin, isChoosen, onChoose}) => {
    let navigate = useNavigate();
    const showID = () => {
        console.log(danhSachMuiTiem)
        navigate(`/vaccine/${maVaccine}`);
    }
    return (
        <Card>
            <ButtonBase onClick={showID}>
                <CardContent>
